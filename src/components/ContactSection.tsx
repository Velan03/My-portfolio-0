...
const ContactSection = () => {
  ...
  const WEB3FORMS_ACCESS_KEY = "eab8d2ee-2fd8-4797-8aa9-558890b6cc9a"; // Get from https://web3forms.com/
          ...
          >
            ...
            >
              ...
              <div className="relative z-10 grid lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                >
                  <motion.div
                    className="relative p-6 sm:p-8 rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden cursor-pointer"
                    style={{
                      background:
                  ...
                  >
                    ...
                    <p className="text-muted-foreground mb-6 sm:mb-8 text-sm sm:text-base relative z-10">
                      Send me a message directly and let's discuss how I can
                      help build your next big project.
                    </p>
                    <motion.div
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 rounded-lg border border-border bg-background focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-2 rounded-lg border border-border bg-background focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all resize-none"
