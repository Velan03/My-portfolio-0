...
const projectsData: Project[] = [
  ...
  },
  {
    ...
    longDescription: "A real-time face mask detection system using deep learning and computer vision. Features include live webcam detection, image upload processing, and high accuracy in various lighting conditions.",
    category: "ai-ml",
  ...
  // NEW PROJECTS
  {
    ...
    longDescription: "A comprehensive Ayurvedic wellness platform featuring online consultations with certified practitioners, authentic Ayurvedic product catalog with detailed ingredients and benefits, personalized wellness recommendations based on body type (Prakriti), and educational blog content about traditional healing practices.",
    category: "website",
  ...
  },
  {
    ...
    longDescription: "A full-featured pharmacy management system including medicine inventory with expiry tracking, prescription management with digital records, barcode scanning for quick billing, sales reports and analytics, customer purchase history, and GST-compliant invoicing. Streamlines pharmacy operations and reduces medication errors.",
    category: "fullstack",
  ...
  },
  {
    ...
    longDescription: "A beautiful e-commerce platform showcasing traditional handmade ornaments including temple jewelry, kundan work, pearl sets, and antique pieces. Features include high-resolution product galleries, customization options, virtual try-on for jewelry, artisan stories, and secure checkout with multiple payment options celebrating traditional craftsmanship.",
    category: "ecommerce",
  ...
  },
  {
    ...
    longDescription: "A comprehensive billing system designed for retail businesses featuring POS interface, invoice generation with customizable templates, barcode scanning support, multiple payment methods (cash, card, UPI), customer loyalty program, GST and tax calculations, inventory sync, daily sales reports, and interactive dashboards with real-time analytics.",
    category: "fullstack",
